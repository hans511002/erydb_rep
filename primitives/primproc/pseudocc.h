...
template<typename W>
#ifdef __GNUC__
// The "official" GCC version for EryDB is 4.5.3. This flag breaks at least 4.4.3 & 4.4.5,
...
template<typename W>void PseudoCC::loadDBRootNum()
{
	loadSingleValue<W>(bpp->dbRoot.getPmDbr());
}
