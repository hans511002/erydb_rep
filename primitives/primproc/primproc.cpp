...
void* waitForSIGUSR1(void* p)
{
	...
	for (;;)
	{
		...
		{
#ifdef _MSC_VER
			ofstream out("C:/erydb/log/trace/pplru.dat");
#else
			ofstream out("/var/log/erydb/trace/pplru.dat");
#endif
...
int main(int argc, char* argv[])
{
	...
	{
#ifdef _MSC_VER
		ofstream* qszLog = new ofstream("C:/erydb/log/trace/ppqsz.dat");
#else
		ofstream* qszLog = new ofstream("/var/log/erydb/trace/ppqsz.dat");
#endif
		if (!qszLog->good())
		{
			qszLog->close();
