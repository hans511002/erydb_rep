...
public:
    ...
    void test_insert_package1()
    {
        ...
        erydbDMLPackage* pDMLPackage = erydbDMLFactory::makeerydbDMLPackage(dmlStmt);
        CPPUNIT_ASSERT( 0 != pDMLPackage );

        cout << "erydbDMLFactory::makeerydbDMLPackage:" << "success" << endl;
    ...
    void write_insert_object( ByteStream& bs, erydbDMLPackage* pDMLPackage )
    {
    ...
    void write_delete_object( ByteStream& bs, erydbDMLPackage* pDMLPackage )
    {
        cout << "Writing out package over bytestream" << endl;
        pDMLPackage->write( bs );
    }
    ...
    void test_command_package()
    {
        ...
        while (iter != commands.end())
        {
            ...
            erydbDMLPackage* dmlCommandPkgPtr = erydbDMLFactory::makeerydbDMLPackage(dml_command);
            if (dmlCommandPkgPtr)
            {
                cout << "erydbDMLFactory::makeerydbDMLPackage: success"  << endl;
                cout << "Writing out package over bytestream" << endl;
    ...
    void write_update_object( ByteStream& bs, erydbDMLPackage* pDMLPackage )
    {
        cout << "Writing out package over bytestream" << endl;
        pDMLPackage->write( bs );
    }
