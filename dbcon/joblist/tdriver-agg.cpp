...
//const string datapath="/usr/local/erydb/bin/lineitem.tbl";
int numConsumers = 1;
int numRuns = 1;
...
public:
    ...
    int64_t convertValueNum(const string& str, const erydbSystemCatalog::ColType& ct, bool isNull )
    {
...
*/
	    ...
	    setUp1(in, out);
	    erydbSystemCatalog::TableName tn("test", "lineitem");	    
	    ...
	    erydbSystemCatalog::ROPair ropair = csc->tableRID(tn);
	    erydbSystemCatalog::OID tableoid = ropair.objnum;
