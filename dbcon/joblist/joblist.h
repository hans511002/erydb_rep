...
typedef std::map<execplan::erydbSystemCatalog::OID, SJSTEP> DeliveredTableMap;
...
public:
	...
	/* returns row count */
	virtual uint32_t projectTable(execplan::erydbSystemCatalog::OID, messageqcpp::ByteStream&) = 0;
	...
	virtual execplan::erydbSystemCatalog::OID* projectingTableOIDPtr()
...
protected:
	...
	// Dirty pool kludge. Contains the number of PMs configured in erydb.xml.
	...
	execplan::erydbSystemCatalog::OID projectingTableOID; //DeliveryWSDLs get a reference to this
	SErrorInfo errInfo;
...
public:
	...
	EXPORT uint32_t projectTable(execplan::erydbSystemCatalog::OID, messageqcpp::ByteStream&);
