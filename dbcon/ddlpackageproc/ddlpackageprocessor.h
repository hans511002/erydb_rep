...
public:
	...
	typedef std::vector<execplan::erydbSystemCatalog::OID> OidList;
	...
	typedef std::map<execplan::erydbSystemCatalog::OID, LogInfo> TableLogInfo;
...
/*
    ...
    struct NJLSysDataList
    {
		...
		int findColumn(const execplan::erydbSystemCatalog::OID& columnOID) 
	{
     ...
     */
    EXPORT void flushPrimprocCache( std::vector<execplan::erydbSystemCatalog::OID>& oidList );
     ...
     */
    EXPORT void removePartitionFiles(std::vector<execplan::erydbSystemCatalog::OID>& oidList, 
     ...
     */
    EXPORT void removeExtents(std::vector<execplan::erydbSystemCatalog::OID>& oidList);
     ...
     */
    EXPORT void createWriteDropLogFile(execplan::erydbSystemCatalog::OID tableOid,  
		uint64_t uniqueId, std::vector<execplan::erydbSystemCatalog::OID>& oidList);
     ...
     */
    EXPORT void createWritePartitionLogFile(execplan::erydbSystemCatalog::OID tableOid, 
    	                                     const PartitionNums& partitionNums, 
											 std::vector<execplan::erydbSystemCatalog::OID>& oidList,
											 uint64_t uniqueId);

    // EXPORT void createOpenTruncateTableLogFile(execplan::erydbSystemCatalog::OID tableOid, execplan::erydbSystemCatalog::TableName tableName);
	 ...
	 *  @param tableName the shcema, table name 
     */
    EXPORT void createWriteTruncateTableLogFile(execplan::erydbSystemCatalog::OID tableOid, uint64_t uniqueId, std::vector<execplan::erydbSystemCatalog::OID>& oidList);
	

	/**  @brief delete log file
     * 
     */
    EXPORT void deleteLogFile(LogFileType fileType, execplan::erydbSystemCatalog::OID tableOid, uint64_t uniqueId);
...
protected:
     ...
     */
    boost::any getNullValueForType(const execplan::erydbSystemCatalog::ColType& colType);
    ...
    /** @brief return a tokenized value for the supplied data value
      ...
      */
    boost::any tokenizeData(execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
                            const execplan::erydbSystemCatalog::ColType& colType,
     ...
     */
    //void writeSysTableMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
     ...
     */
    //void writeSysColumnMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
     ...
     * @param qualifiedName the name of catalog, schema, object names
     */
 //   void writeTableSysConstraintMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
 ...
 //                                        qualifiedName, bool alterFlag=false );
    /** @brief write the table constraint meta data to the SYSCONSTRAINTCOL table
      ...
      * @param qualifiedName the name of catalog, schema, object names
      */
 //   void writeTableSysConstraintColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
 ...
 //                                           ddlpackage::QualifiedName& qualifiedName, bool alterFlag=false );
    ...
    /** @brief write the column constraint meta data to the SYSCONTRAINT table
      ...
      * @param qualifiedName the name of catalog, schema, object names
      */
//    void writeColumnSysConstraintMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
//                                          ddlpackage::ColumnDefList& tableDefCols,
//                                          ddlpackage::QualifiedName& qualifiedName );
    ...
    /** @brief write the column constraint meta data to the SYSCONTRAINTCOL table
      ...
      * @param tableDef the table definition
      */
//    void writeColumnSysConstraintColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
//            const DDLResult& result, ddlpackage::ColumnDefList& tableDefCols,
 //           ddlpackage::QualifiedName& qualifiedName);
     ...
     */
   // void writeSysIndexMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
   //                            ddlpackage::QualifiedName& qualifiedName,
   //                            ddlpackage::DDL_CONSTRAINTS type,
   //                            std::string& indexName, bool multicol, bool alterFlag=false);
     ...
     * @param indexName name of the index
     */
   // void writeSysIndexColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
//ddlpackage::QualifiedName& qualifiedName,
  //                                ddlpackage::ColumnNameList& constraintCols,
   //                               std::string& indexName, bool alterFlag=false);
    ...
    /** @brief remove all indexes for the supplied table from the SYSINDEX table
      ...
      */
    //void removeSysIndexMetaDataForTable(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
    ...
    /** @brief remove all index columns for the supplied table from the SYSINDEXCOL table
      ...
      * @param tableName the qualified name of the table
      */
   // void removeSysIndexColMetaDataForTable(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
   //                                        DDLResult& result, ddlpackage::QualifiedName& tableName);
    ...
    /** @brief remove an index from the SYSINDEX table
      ...
      */
   // void removeSysIndexMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
    ...
    /** @brief remove index columns from the SYSINDEXCOL table
      ...
      * @param indexName the qualified name of the index
      */
   // void removeSysIndexColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
   //                                ddlpackage::QualifiedName& indexName);
    ...
    /** @brief remove the table meta data from the SYSTABLE table
      ...
      */
   // void removeSysTableMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
   //                             ddlpackage::QualifiedName& tableName);
    ...
    /** @brief remove the column meta data from the SYSCOLUMN table
      ...
      * are to be removed
      */
   // void removeSysColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
   //                           ddlpackage::QualifiedName& tableName);
    ...
    /** @brief remove the column meta data from the SYSCOLUMN table
      ...
      * to be removed
      */
   // void removeColSysColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
   //                           ddlpackage::QualifiedName& columnInfo);
    ...
    /**  @brief remove the constraint meta data from the SYSCONSTRAINT table
      ...
      * are to be removed
      */
 //   void removeSysContraintMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
  //                                  ddlpackage::QualifiedName& tableName);
    ...
    /**  @brief remove the constraint meta data from the SYSCONSTRAINT table
      ...
      */                                
 //   void removeSysIndexMetaDataForIndex(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
 //       DDLResult& result,
 //       execplan::erydbSystemCatalog::IndexNameList& indexNameList);                                
    ...
    /**  @brief remove the column constraint meta data from the SYSCONSTRAINTCOL table
      ...
      * are to be removed
      */
  //  void removeSysConstraintColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
   //                                     ddlpackage::QualifiedName& tableName);
      ...
      */   
#if 0	  
    void removeSysContraintMetaDataForConstraint(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID,
        DDLResult& result,
        execplan::erydbSystemCatalog::IndexNameList& constrintNames);                                    
    /**  @brief remove the column constraint meta data from the SYSCONSTRAINTCOL table
      *
      * @param txnID the transaction id
      * @param result the result of the operation
      ...
      * are to be removed
      */
    void removeColSysConstraintColMetaData(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
                                        ddlpackage::QualifiedName& columnInfo);
     ...
     */                           
    void updateSyscolumns( execplan::erydbSystemCatalog::SCN txnID,
     ...
     */
    void removeIndexFiles(execplan::erydbSystemCatalog::SCN txnID, DDLResult& result,
                          execplan::erydbSystemCatalog::IndexOIDList& idxOIDList);
#endif 
     ...
     */
    void returnOIDs(execplan::erydbSystemCatalog::RIDList& ridList,
                    execplan::erydbSystemCatalog::DictOIDList& dictOIDList);
    ...
    /**
      ...
      */
    //boost::any convertColumnData( execplan::erydbSystemCatalog::ColType colType,
    ...
    /**
      ...
      */
    void findColumnData(uint32_t sessionID, execplan::erydbSystemCatalog::TableName& systableName,
    ...
    /** @brief remove the supplied row from the supplied system catalog table
      ...
      */
    void removeRowFromSysCatalog(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
    ...
    bool referenceConstraintViolation(uint32_t sessionID, 
                                      DDLResult& result,
                                      execplan::erydbSystemCatalog::TableColName tcn, 
                                      execplan::erydbSystemCatalog::IndexName refIndexName);
    ...
    /** @brief remove the supplied rows from the supplied system catalog table
      ...
      */
    void removeRowsFromSysCatalog(uint32_t sessionID, execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
                                  ddlpackage::QualifiedName& sysCatalogTableName,
                                  execplan::erydbSystemCatalog::RIDList& colRidList);
    ...
    std::string fPKName;    // primary key name supplied by Oracle. Oracle will issue
                            ...
                            // is to make sure erydb use the same system primary key name as Oracle
