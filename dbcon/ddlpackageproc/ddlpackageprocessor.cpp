...
execplan::erydbSystemCatalog::ColDataType DDLPackageProcessor::convertDataType(int dataType)
{
	...
	switch (dataType)
	{
		case ddlpackage::DDL_CHAR:
			colDataType = erydbSystemCatalog::CHAR;
			break;

		case ddlpackage::DDL_VARCHAR:
			colDataType = erydbSystemCatalog::VARCHAR;
			break;

		case ddlpackage::DDL_VARBINARY:
			colDataType = erydbSystemCatalog::VARBINARY;
			break;

		case ddlpackage::DDL_BIT:
			colDataType = erydbSystemCatalog::BIT;
			break;
		...
		case ddlpackage::DDL_NUMBER:
			colDataType = erydbSystemCatalog::DECIMAL;
			break;

		case ddlpackage::DDL_FLOAT:
			colDataType = erydbSystemCatalog::FLOAT;
			break;

		case ddlpackage::DDL_DOUBLE:
			colDataType = erydbSystemCatalog::DOUBLE;
			break;

		case ddlpackage::DDL_INT:
		case ddlpackage::DDL_INTEGER:
			colDataType = erydbSystemCatalog::INT;
			break;

		case ddlpackage::DDL_BIGINT:
			colDataType = erydbSystemCatalog::BIGINT;
			break;

		case ddlpackage::DDL_MEDINT:
			colDataType = erydbSystemCatalog::MEDINT;
			break;

		case ddlpackage::DDL_SMALLINT:
			colDataType = erydbSystemCatalog::SMALLINT;
			break;

		case ddlpackage::DDL_TINYINT:
			colDataType = erydbSystemCatalog::TINYINT;
			break;

        case ddlpackage::DDL_UNSIGNED_DECIMAL:
        case ddlpackage::DDL_UNSIGNED_NUMERIC:
            colDataType = erydbSystemCatalog::UDECIMAL;
            break;

        case ddlpackage::DDL_UNSIGNED_FLOAT:
            colDataType = erydbSystemCatalog::UFLOAT;
            break;

        case ddlpackage::DDL_UNSIGNED_DOUBLE:
            colDataType = erydbSystemCatalog::UDOUBLE;
            break;

        case ddlpackage::DDL_UNSIGNED_INT:
            colDataType = erydbSystemCatalog::UINT;
            break;

        case ddlpackage::DDL_UNSIGNED_BIGINT:
            colDataType = erydbSystemCatalog::UBIGINT;
            break;

        case ddlpackage::DDL_UNSIGNED_MEDINT:
            colDataType = erydbSystemCatalog::UMEDINT;
            break;

        case ddlpackage::DDL_UNSIGNED_SMALLINT:
            colDataType = erydbSystemCatalog::USMALLINT;
            break;

        case ddlpackage::DDL_UNSIGNED_TINYINT:
            colDataType = erydbSystemCatalog::UTINYINT;
            break;

		case ddlpackage::DDL_DATE:
			colDataType = erydbSystemCatalog::DATE;
			break;

		case ddlpackage::DDL_DATETIME:
			colDataType = erydbSystemCatalog::DATETIME;
			break;

		case ddlpackage::DDL_CLOB:
			colDataType = erydbSystemCatalog::CLOB;
			break;

		case ddlpackage::DDL_BLOB:
			colDataType = erydbSystemCatalog::BLOB;
			break;
...
boost::any
DDLPackageProcessor::getNullValueForType(const execplan::erydbSystemCatalog::ColType& colType)
{
	boost::any value;
...
boost::any DDLPackageProcessor::tokenizeData(execplan::erydbSystemCatalog::SCN txnID, const DDLResult& result,
...
void DDLPackageProcessor::flushPrimprocCache(std::vector<execplan::erydbSystemCatalog::OID>& oidList)
{
	SUMMARY_INFO("DDLPackageProcessor::flushPrimprocCache");

	int err = 0;
	erydbSystemCatalog::ROPair roPair;
	std::vector<erydbSystemCatalog::OID>::const_iterator iter = oidList.begin();
	std::string error;
	BRM::DBRM dbrm;
	BRM::LBIDRange_v lbidRanges;
	LBIDRange_v::iterator it;
	BRM::BlockList_t blockList;
	execplan::erydbSystemCatalog::SCN verID = 0;
	try
	{
...
void DDLPackageProcessor::removeFiles(const uint64_t uniqueId, std::vector<execplan::erydbSystemCatalog::OID>& oidList)
{
...
void DDLPackageProcessor::createFiles(erydbSystemCatalog::TableName aTableName, const DBROOTS_struct& dbRoot,const uint64_t uniqueId, const uint32_t numOids)
{
	...
	erydbSystemCatalog::RIDList ridList = systemCatalogPtr->columnRIDs(aTableName);
	fWEClient->addQueue(uniqueId);
...
void DDLPackageProcessor::removePartitionFiles(std::vector<execplan::erydbSystemCatalog::OID>& oidList, 
...
void DDLPackageProcessor::removeExtents(std::vector<execplan::erydbSystemCatalog::OID>& oidList)
{
...
void DDLPackageProcessor::createWriteDropLogFile(execplan::erydbSystemCatalog::OID tableOid,  
...
void DDLPackageProcessor::deleteLogFile(LogFileType fileType, execplan::erydbSystemCatalog::OID tableOid, uint64_t uniqueId)
{
...
void DDLPackageProcessor::createWritePartitionLogFile(execplan::erydbSystemCatalog::OID tableOid,  
	                                                   const PartitionNums& partitionNums,
	                                                   std::vector<execplan::erydbSystemCatalog::OID>& oidList, uint64_t uniqueId)
{
...
void DDLPackageProcessor::createWriteTruncateTableLogFile(execplan::erydbSystemCatalog::OID tableOid,  uint64_t uniqueId, std::vector<execplan::erydbSystemCatalog::OID>& oidList)
{
...
#if 0
void DDLPackageProcessor::createOpenTruncateTableLogFile(execplan::erydbSystemCatalog::OID tableOid, execplan::erydbSystemCatalog::TableName tableName)
{
	...
	if (prefix.length() == 0) {
		error = "Need a valid DBRMRoot entry in erydb configuation file";
		throw std::runtime_error(error);
	}
...
void DDLPackageProcessor::removeIndexFiles(execplan::erydbSystemCatalog::SCN txnID,
		DDLResult& result,
...
/*	SUMMARY_INFO("DDLPackageProcessor::removeIndexFiles");
	...
	int err = 0;
	erydbSystemCatalog::IndexOID idxOID;
	erydbSystemCatalog::IndexOIDList::const_iterator iter = idxOIDList.begin();
	std::string error;
	try
	{
...
void DDLPackageProcessor::updateSyscolumns(execplan::erydbSystemCatalog::SCN txnID,
...
#endif
void DDLPackageProcessor::returnOIDs(execplan::erydbSystemCatalog::RIDList& ridList,
									 execplan::erydbSystemCatalog::DictOIDList& dictOIDList)
{
	erydbSystemCatalog::ROPair roPair;
	erydbSystemCatalog::RIDList::const_iterator col_iter = ridList.begin();
	std::string err;
	try
	{
		...
		erydbSystemCatalog::DictOIDList::const_iterator dict_iter = dictOIDList.begin();
...
void DDLPackageProcessor::findColumnData(uint32_t sessionID, execplan::erydbSystemCatalog::TableName& systableName,
