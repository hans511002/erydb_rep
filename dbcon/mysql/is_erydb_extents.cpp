...
ST_FIELD_INFO is_erydb_extents_fields[] =
{
...
static int is_erydb_extents_plugin_init(void *p)
{
    ST_SCHEMA_TABLE *schema = (ST_SCHEMA_TABLE*) p;
    schema->fields_info = is_erydb_extents_fields;
    schema->fill_table = is_erydb_extents_fill;
    return 0;
}

static struct st_mysql_information_schema is_erydb_extents_plugin_version =
{ MYSQL_INFORMATION_SCHEMA_INTERFACE_VERSION };

maria_declare_plugin(is_erydb_extents_plugin)
{
    MYSQL_INFORMATION_SCHEMA_PLUGIN,
    &is_erydb_extents_plugin_version,
    "ERYDB_EXTENTS",
    "EryDB, Inc.",
    "An information schema plugin to list EryDB extents",
    PLUGIN_LICENSE_GPL,
    is_erydb_extents_plugin_init,
    //is_erydb_extents_plugin_deinit,
    NULL,
    0x0100,
    NULL,
    NULL,
