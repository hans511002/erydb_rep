...
// $Id: ha_erydb.h 9210 2013-01-21 14:10:42Z rdempsey $
...
*/
class ha_erydb: public handler
{
  THR_LOCK_DATA lock;      ///< MySQL lock
  ERYDB_SHARE *share;    ///< Shared lock info
  ulonglong int_table_flags;

public:
  ha_erydb(handlerton *hton, TABLE_SHARE *table_arg);
  ~ha_erydb()
  {
  }
   ...
   */
  const char *table_type() const { return "EryDB"; }
