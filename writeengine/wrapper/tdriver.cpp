...
public:
   ...
   void SetColumnStruct( ColStruct& column, OID dataOid, int colWidth, erydbSystemCatalog::ColDataType colDataType )
   {
   ...
   void CreateColumnFile( FID fid, int width, erydbSystemCatalog::ColDataType colDataType, ColType colType )
   {
      int rc;
      ColumnOp colOp;
      Column   curCol;
...
//      colOp.setUseBrm(false);
   ...
   void testInsertRowLonglong() {
      ...
      erydbSystemCatalog::ColDataType colDataType = erydbSystemCatalog::BIGINT;
   ...
   void testInsertRowDouble() {
      ...
      erydbSystemCatalog::ColDataType colDataType = erydbSystemCatalog::DOUBLE;
   ...
   void testInsertRowChar() {
      ...
      erydbSystemCatalog::ColDataType colDataType = erydbSystemCatalog::CHAR;
   ...
   void testTableAllocateRowId() {
      ...
      int         width = 4, hwm = 0;
      FID         fid = 100;
      erydbSystemCatalog::ColDataType colDataType = erydbSystemCatalog::INT;
...
//      m_wrapper.printInputValue( (OID)103, colStructList, colValueList, ridList );
   ...
   void SetIndexStruct( IdxStruct& curStruct, OID treeOid, OID listOid, int width, erydbSystemCatalog::ColDataType dataType )
   {
...
void testBoostFloat()
{
   ...
   float             valArray[3];
   uint64_t          oldValArray[3];
   erydbSystemCatalog::ColDataType       colDataType = erydbSystemCatalog::FLOAT;
   ...
   void testSoloman()
   {
     char  fileName[80]="/usr/local/erydb/data1/test.dat";
     char  outfile[80] = "/usr/local/erydb/data1/out.dat";
