...
int DctnryCompress1::updateDctnryExtent(ERYDBDataFile* pFile, int nBlocks)
{
...
int DctnryCompress1::readDBFile(ERYDBDataFile* pFile, unsigned char* readBuf, const uint64_t lbid,
                                const bool isFbo)
{
    int fbo = lbid;
    if (!isFbo)
...
int DctnryCompress1::writeDBFile(ERYDBDataFile* pFile, const unsigned char* writeBuf, const uint64_t lbid,
...
int DctnryCompress1::writeDBFileNoVBCache(ERYDBDataFile* pFile,
