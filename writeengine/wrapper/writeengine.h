...
public:
   ...
   int buildIndex(const OID& colOid, const OID& treeOid, const OID& listOid,
                         execplan::erydbSystemCatalog::ColDataType colDataType, int width, int hwm,
   ...
   int buildIndex(const std::string& sourceFileName, const OID& treeOid, const OID& listOid,
                         execplan::erydbSystemCatalog::ColDataType colDataType, int width, int hwm, bool resetFile,
    ...
    */
   EXPORT int fillColumn(const TxnID& txnid, const OID& dataOid, execplan::erydbSystemCatalog::ColDataType dataType,
                         int dataWidth, ColTuple defaultVal,
                         const OID& refColOID, execplan::erydbSystemCatalog::ColDataType refColDataType,
...
private:
    ...
    */
   int processVersionBuffer(ERYDBDataFile* pFile, const TxnID& txnid, const ColStruct& colStruct,
    ...
    */
   int processVersionBuffers(ERYDBDataFile* pFile, const TxnID& txnid, const ColStruct& colStruct,
    ...
    */
    ...
    int AddLBIDtoList(const TxnID     txnid,
                      ...
                      std::vector<execplan::erydbSystemCatalog::ColDataType>& colDataTypes,
