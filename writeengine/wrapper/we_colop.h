...
public:
    ...
    */
   EXPORT virtual bool getColDataType(const char* name, execplan::erydbSystemCatalog::ColDataType& colDataType) const;
   ...
   EXPORT virtual void setColParam(Column& column, int colNo = 0,
                                  int colWidth = 0,
                                  execplan::erydbSystemCatalog::ColDataType colDataType = execplan::erydbSystemCatalog::INT,
    ...
    */
   virtual bool abbreviatedExtent(ERYDBDataFile* pFile, int colWidth) const = 0;

   /**
    * @brief Caculate the number of blocks in file.
    */
   virtual int blocksInFile(ERYDBDataFile* pFile) const = 0;
    ...
    */
   virtual ERYDBDataFile*  openFile(const Column& column, uint16_t dbRoot, uint32_t partition,
    ...
    */
   int writeVB(ERYDBDataFile* pSource, const OID sourceOid, ERYDBDataFile* pTarget, const OID targetOid,
    ...
    */
   int copyVB(ERYDBDataFile* pSource, const BRM::VER_t txnD, const OID oid, std::vector<uint32_t>& fboList,
...
protected:
    ...
    */
   virtual int readBlock(ERYDBDataFile* pFile, unsigned char* readBuf, const uint64_t fbo) = 0;

   /**
    * @brief output writeBuf to pFile starting at position fbo
    */
   virtual int saveBlock(ERYDBDataFile* pFile, const unsigned char* writeBuf, const uint64_t fbo) = 0;
