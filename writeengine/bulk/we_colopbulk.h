...
class ColumnOpBulk : public ColumnOp
{
  public:
    ...
    virtual ERYDBDataFile* openFile(const WriteEngine::Column& column,uint16_t dbr, uint32_t partition, uint16_t segment,std::string& segFile, bool useTmpSuffix, const char* mode = "r+b",
