...
//------------------------------------------------------------------------------
bool  ColumnOpBulk::abbreviatedExtent(ERYDBDataFile*, int) const
{
...
//------------------------------------------------------------------------------
int   ColumnOpBulk::blocksInFile(ERYDBDataFile*) const
{
    throw std::logic_error(
...
// Stub for readBlock
//------------------------------------------------------------------------------
int   ColumnOpBulk::readBlock(ERYDBDataFile*, unsigned char*, const uint64_t)
{
    throw std::logic_error(
...
// Stub for writeBlock
//------------------------------------------------------------------------------
int   ColumnOpBulk::saveBlock(ERYDBDataFile*, const unsigned char*, const uint64_t)
{
    throw std::logic_error(
