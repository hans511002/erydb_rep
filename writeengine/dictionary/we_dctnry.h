...
protected:
    ...
    int   getEndOp       (ERYDBDataFile* dFile, int fbo, int &op);
    ...
    virtual ERYDBDataFile* createDctnryFile(const char *name, int width,
                                   const char *mode, int ioBuffSize);
    virtual ERYDBDataFile* openDctnryFile(bool useTmpSuffix);
