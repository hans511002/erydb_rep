...
namespace WriteEngine
{
	typedef erydbdatafile::ERYDBDataFile ERYDBDataFile;
...
//      WR_LONG             = 5,            /** @brief Long */
   ...
   /**
    * the set of erydb column data type names; MUST match ColDataType in
    * erydbsystemcatalog.h.
    */
    const char  ColDataTypeStr[execplan::erydbSystemCatalog::NUM_OF_COL_DATA_TYPE][20] = {
                "bit",
                "tinyint",
                "char",
                "smallint",
    ...
    ************************************************************************/
    struct Column                           /** @brief Column structure */
    {
        ...
        execplan::erydbSystemCatalog::ColDataType colDataType; /** @brief column data type (from interface)*/
        ...
        Column() : colNo(0), colWidth(0), colType(WR_INT),
                   colDataType(execplan::erydbSystemCatalog::INT), 
                   compressionType(erydbdatafile::ERYDBPolicy::useHdfs()?2:0) { }
    };
   ...
   typedef std::vector<ColTuple>  ColTupleList; /** @brief column value list */
    ...
    struct ColStruct                        /** @brief Column Interface Struct*/
    {
        ...
        execplan::erydbSystemCatalog::ColDataType    colDataType;         /** @brief column data type (for interface)*/
    ...
    ************************************************************************/
    struct JobColumn                        /** @brief Job Column Structure */
    {
        ...
        execplan::erydbSystemCatalog::ColDataType    dataType;            /** @brief column data type */
        ...
        JobColumn() : mapOid(0), dataType(execplan::erydbSystemCatalog::INT), weType(WR_INT),
