...
ConfirmHdfsDbFile::ConfirmHdfsDbFile() :
    fFs( (erydbdatafile::ERYDBPolicy::useHdfs()) ?
        erydbdatafile::ERYDBFileSystem::getFs(erydbdatafile::ERYDBDataFile::HDFS) :
        erydbdatafile::ERYDBFileSystem::getFs(erydbdatafile::ERYDBDataFile::BUFFERED))
{
}

//------------------------------------------------------------------------------
