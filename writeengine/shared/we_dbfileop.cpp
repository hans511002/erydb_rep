 ...
 ***********************************************************/
int DbFileOp::readDBFile( ERYDBDataFile* pFile,
 ...
 *    other number if something wrong
 ***********************************************************/
const int DbFileOp::readSubBlockEntry( ERYDBDataFile* pFile, DataBlock* block,
 ...
 ***********************************************************/
int DbFileOp::writeDBFileNoVBCache( ERYDBDataFile* pFile,
                                    const unsigned char* writeBuf,
                                    const int fbo,
                                    const int numOfBlock  )
{
 ...
 ***********************************************************/
int DbFileOp::writeDBFile( ERYDBDataFile* pFile, const unsigned char* writeBuf,
...
int DbFileOp::writeDBFileFbo(ERYDBDataFile* pFile, const unsigned char* writeBuf,
 ...
 *    other number if something wrong
 ***********************************************************/
const int DbFileOp::writeSubBlockEntry( ERYDBDataFile* pFile, DataBlock* block,
                                        const uint64_t lbid, const int sbid, 
                                        const int entryNo, const int width, 
                                        void* pStruct )
{
...
int DbFileOp::readDbBlocks(ERYDBDataFile* pFile,
                           unsigned char* readBuf,
                           uint64_t fbo,
                           size_t n)
{
...
int DbFileOp::restoreBlock(ERYDBDataFile* pFile, const unsigned char* writeBuf, uint64_t fbo)
{
    if (m_chunkManager)
