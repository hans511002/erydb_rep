...
namespace BRM {
    ...
    int DBRM::lookupLocal(LBID_t lbid, VER_t verid, bool vbFlag, OID_t& oid, DBROOTS_struct& dbRoot, uint32_t& partitionNum, uint16_t& segmentNum, FBO_struct &fileBlockOffset) throw() {
#ifdef BRM_INFO
        if (fDebug) {
...
//    }
    ...
    void DBRM::invalidateUncommittedExtentLBIDs(execplan::erydbSystemCatalog::SCN txnid, vector<LBID_t>* plbidList) {
        ...
        csc = execplan::erydbSystemCatalog::makeerydbSystemCatalog();
