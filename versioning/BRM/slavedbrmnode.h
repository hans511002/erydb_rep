 ...
 *
 * The erydb configuration file should contain entries for the Master
...
class SlaveDBRMNode {
	public:
		 ...
		 */
		EXPORT int beginVBCopy(VER_t transID, const DBROOTS_struct &  vbOID,uint8_t dbrIndex,  const LBIDRange_v& ranges, VBRange_v& freeList, bool flushPMCache) throw();
