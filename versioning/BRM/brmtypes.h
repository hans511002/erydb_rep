...
typedef execplan::erydbSystemCatalog::OID OID_t;  
...
#define MAX_PROCNAME 16
		...
		struct _TxnID {
			...
			execplan::erydbSystemCatalog::SCN		id;
...
struct CPInfoMerge {
    ...
    execplan::erydbSystemCatalog::ColDataType type;
...
typedef std::tr1::unordered_map<execplan::erydbSystemCatalog::OID, execplan::erydbSystemCatalog::OID> OidsMap_t;
...
typedef std::tr1::unordered_map<execplan::erydbSystemCatalog::OID, ExtentInfo> ExtentsInfoMap_t;
...
struct TableLockInfo : public messageqcpp::Serializeable {
	...
	EXPORT void deserialize(std::istream &);
	EXPORT void deserialize(messageqcpp::ByteStream &bs);
	EXPORT void serialize(erydbdatafile::ERYDBDataFile*) const;
	EXPORT void deserialize(erydbdatafile::ERYDBDataFile*);
...
public:
	...
	execplan::erydbSystemCatalog::SCN currentScn;
	boost::shared_ptr<std::vector<execplan::erydbSystemCatalog::SCN> > currentTxns;
