...
void title(string outputFile = "erydbSupportReport.txt")
{
	...
	system(cmd.c_str());
	cmd = "echo ' erydbSupportReport script ran from Module " + localModule + " on " + currentDate + "' >> " + outputFile;
	system(cmd.c_str());
	cmd = "echo ' ' >> " + outputFile;
	system(cmd.c_str());
	cmd = "echo '%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%' >> " + outputFile;
...
//cout << "++ " << runningThreads << endl;
	...
	if (reportType == "log")
	{
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# eryadmin getLogConfig ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = installDir + "/bin/eryadmin getLogConfig >> " + outputFile;
			system(cmd.c_str());
	}
	else
	{
		...
		if (reportType == "config" )
		{
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# eryadmin getSystemNetworkConfig ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = installDir + "/bin/eryadmin getSystemNetworkConfig >> " + outputFile;
			system(cmd.c_str());
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# eryadmin getModuleTypeConfig ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = installDir + "/bin/eryadmin getModuleTypeConfig >> " + outputFile;
			system(cmd.c_str());
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# eryadmin getStorageConfig ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = installDir + "/bin/eryadmin getStorageConfig >> " + outputFile;
			system(cmd.c_str());
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# eryadmin getStorageStatus ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = installDir + "/bin/eryadmin getStorageStatus >> " + outputFile;
			system(cmd.c_str());
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# eryadmin getSystemInfo ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = installDir + "/bin/eryadmin getSystemInfo >> " + outputFile;
			system(cmd.c_str());
			...
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo '################# cat /etc/erydb.xml ################# ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "echo ' ' >> " + outputFile;
			system(cmd.c_str());
			cmd = "cat " + installDir + "/etc/erydb.xml >> " + outputFile;
			system(cmd.c_str());
		}
		...
		{
			if (LOCAL) {
				cmd = "echo '################# eryadmin getModuleResourceUsage ################# ' >> " + outputFile;
				system(cmd.c_str());
				cmd = "echo ' ' >> " + outputFile;
				system(cmd.c_str());
				string cmd = installDir + "/bin/eryadmin getModuleResourceUsage " + localModule + " >> " + outputFile;
				system(cmd.c_str());
			}
			else
			{
				cmd = "echo '################# eryadmin getSystemResourceUsage ################# ' >> " + outputFile;
				system(cmd.c_str());
				cmd = "echo ' ' >> " + outputFile;
				system(cmd.c_str());
				string cmd = installDir + "/bin/eryadmin getSystemResourceUsage >> " + outputFile;
				system(cmd.c_str());
			}
		}
	}
...
int main(int argc, char *argv[])
{
	...
	{
		cout << "ERROR: Problem accessing Erydb configuration file" << endl;
		exit(-1);
	}
   ...
   for( int i = 1; i < argc; i++ )
   {
		if( string("-h") == argv[i] ) {
			cout << endl;
			cout << "'erydbSupport' generates a Set of System Support Report Files in a tar file" << endl;
			cout << "called erydbSupportReport.'system-name'.tar.gz in the local directory." << endl;
			...
			cout << endl;
			cout << "Usage: erydbSupport [-h][-a][-hw][-s][-c][-db][-r][-l][-bl][-lc][-p 'root-password'][-mp 'mysql-root-password'][-de]";
			...
			cout << "			-l  Output Erydb Log/Alarms Reports only" << endl;
			cout << "			-bl Output Erydb Bulk Log Reports only" << endl;
	...
	if ( (localModule != PrimaryUMModuleName) && DBMS )
	{
		...
		while(true)
		{
			...
			cout << "You need to run the erydbSupport command on module '" << PrimaryUMModuleName << "' to get that information." << endl;
	...
	// create a clean Erydb Support Report
	...
	if ( DBMS ) {
		system("rm -f erydbSupportReport.txt;touch erydbSupportReport.txt");
		title();

		system("echo '=======================================================================' >> erydbSupportReport.txt");
		system("echo '=                    DBMS Report                                      =' >> erydbSupportReport.txt");
		system("echo '=======================================================================' >> erydbSupportReport.txt");
		...
		{
			cout << "     FAILED: run erydbSupport on '" << PrimaryUMModuleName << "' to get the dbrm report" << endl;
			FAILED = true;
		}
		else
		{
			// check if mysql is supported and get info
			string erydbMysql = installDir + "/mysql/bin/mysql --defaults-file=" + installDir + "/mysql/my.cnf -u root ";
			string cmd = erydbMysql + " -e 'status' > /tmp/erydbmysql.log 2>&1";
			system(cmd.c_str());

			//check for mysql password set
			string pwprompt = " ";
	
			if (oam.checkLogStatus("/tmp/erydbmysql.log", "ERROR 1045") ) {
				...
				string cmd = erydbMysql + pwprompt + " -e 'status' > /tmp/erydbmysql.log 2>&1";
				system(cmd.c_str());
			...
			{	
				// check if mysql is supported and get info
				string erydbMysql = installDir + "/mysql/bin/mysql --defaults-file=" + installDir + "/mysql/my.cnf -u root " + pwprompt;
				string cmd = erydbMysql + " -V > /dev/null 2>&1";
				int ret = system(cmd.c_str());
				if ( WEXITSTATUS(ret) == 0) {
					// run DBMS report info
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS Erydb Mysql Version ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " -e status ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " -e 'status' >> erydbSupportReport.txt";
					system(cmd.c_str());
			
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS EryDB System Column  ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " -e desc erydbsys.syscolumn ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " -e 'desc erydbsys.syscolumn;' >> erydbSupportReport.txt";
					system(cmd.c_str());
			
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS EryDB System Table  ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " -e desc erydbsys.systable ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " -e 'desc erydbsys.systable;' >> erydbSupportReport.txt";
					system(cmd.c_str());
			
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS EryDB System Catalog Data ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " erydbsys < " + installDir + "/mysql/dumpcat_mysql.sql ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " erydbsys < " + installDir + "/mysql/dumpcat_mysql.sql >> erydbSupportReport.txt";
					system(cmd.c_str());
			
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS EryDB System Table Data ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " -e select * from erydbsys.systable ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " -e 'select * from erydbsys.systable;' >> erydbSupportReport.txt";
					system(cmd.c_str());
			
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS EryDB Usernames ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " -e show databases ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " -e 'show databases;' >> erydbSupportReport.txt";
					system(cmd.c_str());
		
					system("echo ' ' >> erydbSupportReport.txt");
					system("echo '******************** DBMS EryDB variables ********************' >> erydbSupportReport.txt");
					system("echo ' ' >> erydbSupportReport.txt");
					cmd = "echo '################# " + erydbMysql + " show variables ################# ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = "echo ' ' >> erydbSupportReport.txt";
					system(cmd.c_str());
					cmd = erydbMysql + " -e 'show variables;' >> erydbSupportReport.txt";
					system(cmd.c_str());
				}
			}
		}
		...
		system("echo ' ' >> erydbSupportReport.txt");
		system("echo '******************** Database Size Report ********************' >> erydbSupportReport.txt");
		system("echo ' ' >> erydbSupportReport.txt");
		...
		if (File) {
			...
			string cmd = "echo '################# /bin/databaseSizeReport ################# ' >> erydbSupportReport.txt";
			system(cmd.c_str());
			cmd = "echo ' ' >> erydbSupportReport.txt";
			system(cmd.c_str());
			cmd = installDir + "/bin/databaseSizeReport >> erydbSupportReport.txt";
			system(cmd.c_str());
		}

		system("echo ' ' >> erydbSupportReport.txt");
		system("echo '******************** DBMS EryDB config file ********************' >> erydbSupportReport.txt");
		system("echo ' ' >> erydbSupportReport.txt");
		string cmd = "echo '################# cat /mysql/my.cnf ################# ' >> erydbSupportReport.txt";
		system(cmd.c_str());
		cmd = "echo ' ' >> erydbSupportReport.txt";
		system(cmd.c_str());
		cmd = "cat " + installDir + "/mysql/my.cnf 2>/dev/null >> erydbSupportReport.txt";
		system(cmd.c_str());

		system("echo ' ' >> erydbSupportReport.txt");
		system("echo '******************** Active Queries ********************' >> erydbSupportReport.txt");
		system("echo ' ' >> erydbSupportReport.txt");
		cmd = "echo '################# eryadmin getActiveSqlStatement ################# ' >> erydbSupportReport.txt";
		system(cmd.c_str());
		cmd = "echo ' ' >> erydbSupportReport.txt";
		system(cmd.c_str());
		cmd = installDir + "/bin/eryadmin getActiveSqlStatement >> erydbSupportReport.txt";
		system(cmd.c_str());

		cmd = "cat erydbSupportReport.txt > " + localModule + "_dbmsReport.txt";
		system(cmd.c_str());
	}
...
//cout << "check " << runningThreads << endl;
	...
	system("rm -f erydbSupportReport.txt");

	system("unix2dos *Report.txt > /dev/null 2>&1");
	system("rm -rf erydbSupportReport;mkdir erydbSupportReport;mv *Report.txt erydbSupportReport/. > /dev/null 2>&1;mv *Report.tar.gz erydbSupportReport/. > /dev/null 2>&1");
	string cmd = "tar -zcf erydbSupportReport." + systemName + ".tar.gz erydbSupportReport/*";
	system(cmd.c_str());


	cout << endl << "Erydb Support Script Successfully completed, files located in erydbSupportReport." + systemName + ".tar.gz" << endl;
}
