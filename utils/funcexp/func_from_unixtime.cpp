...
erydbSystemCatalog::ColType Func_from_unixtime::operationType( FunctionParm& fp, erydbSystemCatalog::ColType& resultType )
{
...
{	
	...
	if (parm.size() == 2)
	{
		...
		return helpers::ERYDB_date_format(dt, format);
	}
