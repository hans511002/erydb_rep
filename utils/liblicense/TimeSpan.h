...
//**********************************************                                    
		...
		inline string ToString()
		{
			...
			if(this->_ticks!=0)
			{
				if(v[0]!=0 && v[4]!=0)
				{
					sprintf(b,"%d.%02d:%02d:%02d.%03d",v[0],v[1],v[2],v[3],v[4]);
				}
				else if(v[0]!=0 && v[4]==0)
				{
					sprintf(b,"%d.%02d:%02d:%02d",v[0],v[1],v[2],v[3]);
				}
				else if(v[0]==0 && v[4]!=0)
				{
					sprintf(b,"%02d:%02d:%02d.%03d",v[1],v[2],v[3],v[4]);
				}
				else if(v[0]==0 && v[4]==0)
				{
					sprintf(b,"%02d:%02d:%02d",v[1],v[2],v[3]);
				}
				_result=b;
			}
			else
